...
public class PauseService
{
    ...
    private PrimaryPermissions _pausedPrimaryPermissions = PrimaryPermissions.None;
    private SpeakPermissions _pausedSpeakPermissions = SpeakPermissions.None;
    ...
    public bool IsFeaturePaused(PrimaryPermissions permissions) 
        => (_pausedPrimaryPermissions & permissions) is not 0;
    
    public bool IsFeaturePaused(SpeakPermissions permissions) 
    ...
    public void ToggleFeature(PrimaryPermissions permissions) 
        => _pausedPrimaryPermissions ^= permissions;
    
    public void ToggleFeature(SpeakPermissions permissions) 
