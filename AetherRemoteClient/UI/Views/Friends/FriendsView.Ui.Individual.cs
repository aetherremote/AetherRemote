...
public partial class FriendsView
{
    ...
    private void DrawIndividualPermissions(float width)
    {
        ...
        var count = _selectionManager.Selected.Count;
        ...
        {
            SharedUserInterfaces.MediumText(_selectionManager.Selected.FirstOrDefault() is not { } friend ? "Note" : $"Note for {friend.FriendCode}");
            ImGui.SetNextItemWidth(width - AetherRemoteImGui.WindowPadding.X * 2);
            ImGui.InputText("##Note", ref _individual.Note, 32);
        });
        ...
        SharedUserInterfaces.ContentBox("PermissionsIndividualPrimary", AetherRemoteColors.PanelColor, true, () =>
        {
            ...
            DrawIndividualPermissionRow("Body Swap", denyPosition, inheritPosition, allowPosition, ref _individual.BodySwapValue);
            DrawIndividualPermissionRow("Customize+", denyPosition, inheritPosition, allowPosition, ref _individual.CustomizePlusValue);
            DrawIndividualPermissionRow("Emote", denyPosition, inheritPosition, allowPosition, ref _individual.EmoteValue);
            DrawIndividualPermissionRow("Glamourer", denyPosition, inheritPosition, allowPosition, ref _individual.GlamourerValue);
            DrawIndividualPermissionRow("Honorific", denyPosition, inheritPosition, allowPosition, ref _individual.HonorificValue);
            DrawIndividualPermissionRow("Hypnosis", denyPosition, inheritPosition, allowPosition, ref _individual.HypnosisValue);
        ...
        SharedUserInterfaces.ContentBox("PermissionsIndividualSpeak", AetherRemoteColors.PanelColor, true, () =>
        {
            ...
            DrawIndividualPermissionRow("Alliance", denyPosition, inheritPosition, allowPosition, ref _individual.AllianceValue);
            DrawIndividualPermissionRow("Echo", denyPosition, inheritPosition, allowPosition, ref _individual.EchoValue);
            DrawIndividualPermissionRow("Free Company", denyPosition, inheritPosition, allowPosition, ref _individual.FreeCompanyValue);
            DrawIndividualPermissionRow("Party", denyPosition, inheritPosition, allowPosition, ref _individual.PartyValue);
            DrawIndividualPermissionRow("PvP Team", denyPosition, inheritPosition, allowPosition, ref _individual.PvPTeamValue);
            DrawIndividualPermissionRow("Roleplay", denyPosition, inheritPosition, allowPosition, ref _individual.RoleplayValue);
            DrawIndividualPermissionRow("Say", denyPosition, inheritPosition, allowPosition, ref _individual.SayValue);
            DrawIndividualPermissionRow("Shout", denyPosition, inheritPosition, allowPosition, ref _individual.ShoutValue);
            DrawIndividualPermissionRow("Tell", denyPosition, inheritPosition, allowPosition, ref _individual.TellValue);
            DrawIndividualPermissionRow("Yell", denyPosition, inheritPosition, allowPosition, ref _individual.YellValue);
            ...
            for (uint index = 0; index < 8; index++)
                DrawIndividualLinkshellPermissionRow(index, true, denyPosition, inheritPosition, allowPosition, ref _individual.LinkshellValues[index]);
            ...
            ImGui.Separator();
            for (uint index = 0; index < 8; index++)
                DrawIndividualLinkshellPermissionRow(index, false, denyPosition, inheritPosition, allowPosition, ref _individual.CrossWorldLinkshellValues[index]);
        });
        ...
        SharedUserInterfaces.ContentBox("PermissionsIndividualSave", AetherRemoteColors.PanelColor, false, () =>
        {
            if (ImGui.Button("Save Changes", new Vector2(width - AetherRemoteImGui.WindowPadding.X * 3 - AetherRemoteDimensions.SendCommandButtonHeight, AetherRemoteDimensions.SendCommandButtonHeight)))
                _ = SaveIndividualPermissions().ConfigureAwait(false);
            ...
            if (SharedUserInterfaces.IconButton(FontAwesomeIcon.Trash, new Vector2(AetherRemoteDimensions.SendCommandButtonHeight)))
                _ = DeleteIndividualPermissions().ConfigureAwait(false);
