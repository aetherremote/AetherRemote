...
#if DEBUG
    private const string AuthenticationUrl = "https://localhost:5006/api/auth/login";
#else
    private const string AuthenticationUrl = "https://foxitsvc.com:5006/api/auth/login";
#endif
